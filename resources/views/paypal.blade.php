...
<body style="background-color: rgba(0, 0, 0, 0.096)">
<div class="container">
    <div class="row mt-5 mb-5">
        <div class="col-10 offset-1 mt-1">
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="text-white text-center" >Laravel PayPal Payment Gateway Integration Sample</h3>
                </div>
                <div class="card-body p-0">
                    ...
                    <form action="{{ route('paypal.payment') }}" class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
                        @csrf
                        <div class="mb-6 grid grid-cols-2 gap-4">
                                  ...
                                  <div>
                                    ...
                                    <div class="relative">
                                      ...
                                      <input datepicker datepicker-format="mm/yy" disabled value="08/2050" id="card-expiration-input" type="text" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-9 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="12/23" required />
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <input type="number" id="cvv-input" aria-describedby="helper-text-explanation" disabled value="123456"  class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="•••" required />
                                  </div>
                                </div>
                                <input type="text" name="price" id="pirce" hidden value="20">


                                <button type="submit" class="hidden flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Pay now</button>
                    ...
                    @endif
                        <button type="submit" class="w-full bg-blue-400 rounded-md font-bold text-white p-2">
                            Pay with PayPal
                        </button>
                            {{-- <center>
                                <a href="{{ route('paypal.payment') }}" class="w-full btn bg-blue-400 font-bold text-white">Pay with PayPal </a>
                            </center> --}}
                </form>
                                ...
                                <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
                                  <div class="space-y-2">
                                    <dl class="flex items-center justify-between gap-4">
                                      ...
                                      <dd class="text-base font-medium text-gray-900 dark:text-white">$12.00</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                                      <dd class="text-base font-medium text-green-500">-$1.00</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Store Pickup</dt>
                                      <dd class="text-base font-medium text-gray-900 dark:text-white">$11.55</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Tax</dt>
                                      <dd class="text-base font-medium text-gray-900 dark:text-white">$8.00</dd>
                                    </dl>
                                  </div>

                                  <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                    <dt class="text-base font-bold text-gray-900 dark:text-white">Total</dt>
                                    <dd class="text-base font-bold text-gray-900 dark:text-white">$20.00</dd>
                                  </dl>
                                </div>
                            ...
                            <p class="hidden mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8 lg:text-left">
